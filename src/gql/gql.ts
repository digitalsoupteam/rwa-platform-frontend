...
const documents: Documents = {
    ...
    "\n  query GetPoolsForDebtRepayments($input: FilterInput!) {\n    getPools(input: $input) {\n      id\n      name\n      poolAddress\n      rwaAddress\n      businessId\n      ownerId\n      ownerType\n      virtualHoldReserve\n      realHoldReserve\n      virtualRwaReserve\n      exitFeePercent\n      incomingTranches {\n        amount\n        expiredAt\n        returnedAmount\n      }\n      lastCompletedIncomingTranche\n    }\n  }\n": types.GetPoolsForDebtRepaymentsDocument,
    "\n  query GetBusinessesForDebtRepayments($input: FilterInput!) {\n    getBusinesses(input: $input) {\n      id\n      name\n      ownerId\n      ownerType\n    }\n  }\n": types.GetBusinessesForDebtRepaymentsDocument,
    "\n  query GetCompaniesForDebtRepayments($input: GetCompaniesInput) {\n    getCompanies(input: $input) {\n      id\n      name\n    }\n  }\n": types.GetCompaniesForDebtRepaymentsDocument,
    "\n  query GetDebtRepaymentTransactions($input: GetTransactionsInput!) {\n    getTransactions(input: $input) {\n      id\n      from\n      to\n      poolAddress\n      transactionHash\n      amount\n      createdAt\n    }\n  }\n": types.GetDebtRepaymentTransactionsDocument,
    "\n  query GetPoolRecipients($input: GetBalancesInput!) {\n    getBalances(input: $input) {\n      id\n      owner\n      balance\n    }\n  }\n": types.GetPoolRecipientsDocument,
    ...
    "\n  query GetPoolsForPortfolio($input: FilterInput!) {\n    getPools(input: $input) {\n      id\n      name\n      poolAddress\n      rwaAddress\n      businessId\n      tags\n      riskScore\n      rewardPercent\n      fixedSell\n      expectedHoldAmount\n      expectedRwaAmount\n      awaitingRwaAmount\n      realHoldReserve\n      virtualHoldReserve\n      virtualRwaReserve\n      exitFeePercent\n      isTargetReached\n      isFullyReturned\n      entryPeriodExpired\n      completionPeriodExpired\n      incomingTranches {\n        amount\n        expiredAt\n        returnedAmount\n      }\n      lastCompletedIncomingTranche\n      image\n    }\n  }\n": types.GetPoolsForPortfolioDocument,
    "\n  query GetBusinessesForPortfolio($input: FilterInput!) {\n    getBusinesses(input: $input) {\n      id\n      name\n      ownerId\n      ownerType\n      tags\n      businessType\n      country\n      description\n    }\n  }\n": types.GetBusinessesForPortfolioDocument,
    "\n  query GetCompaniesForPortfolio($input: GetCompaniesInput) {\n    getCompanies(input: $input) {\n      id\n      name\n    }\n  }\n": types.GetCompaniesForPortfolioDocument,
    "\n  query GetPoolTransactionsForPortfolio($input: GetPoolTransactionsInput!) {\n    getPoolTransactions(input: $input) {\n      id\n      userAddress\n      poolAddress\n      transactionType\n      holdAmount\n      rwaAmount\n      bonusAmount\n      createdAt\n    }\n  }\n": types.GetPoolTransactionsForPortfolioDocument,
    ...
    "\n  query GetBalancesForWithdrawals($input: GetBalancesInput!) {\n    getBalances(input: $input) {\n      id\n      owner\n      poolAddress\n      tokenAddress\n      tokenId\n      chainId\n      balance\n    }\n  }\n": types.GetBalancesForWithdrawalsDocument,
    "\n  query GetPoolsForWithdrawals($input: FilterInput!) {\n    getPools(input: $input) {\n      id\n      name\n      poolAddress\n      rwaAddress\n      businessId\n      entryFeePercent\n      exitFeePercent\n      expectedHoldAmount\n      expectedRwaAmount\n      awaitingRwaAmount\n      realHoldReserve\n      virtualHoldReserve\n      virtualRwaReserve\n      isTargetReached\n      isFullyReturned\n      entryPeriodExpired\n      completionPeriodExpired\n    }\n  }\n": types.GetPoolsForWithdrawalsDocument,
    "\n  query GetBusinessesForWithdrawals($input: FilterInput!) {\n    getBusinesses(input: $input) {\n      id\n      name\n      ownerId\n      ownerType\n    }\n  }\n": types.GetBusinessesForWithdrawalsDocument,
    "\n  query GetCompaniesForWithdrawals($input: GetCompaniesInput) {\n    getCompanies(input: $input) {\n      id\n      name\n    }\n  }\n": types.GetCompaniesForWithdrawalsDocument,
    "\n  query GetWithdrawalTransactions($input: GetTransactionsInput!) {\n    getTransactions(input: $input) {\n      id\n      from\n      to\n      poolAddress\n      transactionHash\n      amount\n      createdAt\n    }\n  }\n": types.GetWithdrawalTransactionsDocument,
};
