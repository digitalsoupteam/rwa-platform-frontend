...
export type UpdateAssistantMutation = { __typename?: 'Mutation', updateAssistant: { __typename?: 'Assistant', id: string, name: string, contextPreferences: Array<AssistantContext> } };
...
export type CreateMessageMutation = { __typename?: 'Mutation', createMessage: Array<{ __typename?: 'Message', id: string, assistantId: string, text: string, sender: MessageSender }> };
...
export type GetMessageHistoryQuery = { __typename?: 'Query', getMessageHistory: Array<{ __typename?: 'Message', id: string, assistantId: string, text: string, sender: MessageSender }> };
