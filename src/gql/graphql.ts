...
export type GetPoolsQuery = { __typename?: 'Query', getPools: Array<{ __typename?: 'Pool', id: string, name: string, description?: string | null, poolAddress?: string | null, expectedHoldAmount?: string | null, rewardPercent?: string | null, entryPeriodStart?: number | null, entryPeriodExpired?: number | null, completionPeriodExpired?: number | null, paused: boolean, chainId: string, createdAt: number }> };
