...
const PortfolioFilterModal: FC<Props> = ({
  ...
  return (
    <div ref={ref} className="absolute top-full left-0 z-50 flex gap-1 pt-1">
      {/* Category list */}
      <div className="bg-bg-primary border border-stroke-primary rounded-lg shadow-[0px_2px_13.4px_0px_rgba(0,0,0,0.2)] py-2 w-[200px]">
      ...
      {/* Options panel for selected category */}
      {options.length > 0 && (
        <div className="bg-bg-primary border border-stroke-primary rounded-lg shadow-[0px_2px_13.4px_0px_rgba(0,0,0,0.2)] py-4 w-[200px]">
