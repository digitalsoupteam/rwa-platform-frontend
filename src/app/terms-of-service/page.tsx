      ...
      <Wrapper>
        <div className={'z-1 relative max-w-[670px] mx-auto'}>
          ...
          <div className={'text-grey-dark text-base mb-10'}>
            By accessing this platform, you agree to comply with all terms and conditions set forth herein. Your use of
            the services provided is contingent upon your acceptance of these terms. If you do not agree with any part
            of these terms, you must refrain from using the platform. Your continued use signifies your acceptance of
          ...
          <div className={'text-grey-dark text-base mb-10'}>
            ...
            needed to make informed decisions based on current market trends and their unique financial aspirations. By
            engaging with our services, you acknowledge your understanding of the inherent risks associated with
          ...
          <div className={'text-grey-dark text-base mb-10'}>
            Our investment platform is crafted to provide users with a comprehensive array of advanced tools designed to
            enhance the management and growth of their financial portfolios. Users can delve into a wide variety of
            ...
            conditions and personal financial objectives. By utilizing our services, you acknowledge the inherent risks
            of investing and agree to comply with our terms and conditions. We highly recommend that users take
            advantage of our educational resources, which provide essential knowledge about market trends and investment
            tactics, equipping you to effectively navigate the intricacies of the financial world. Our steadfast
            dedication to user satisfaction is evident in our ongoing updates and improvements to the platform, ensuring
            you have access to the latest tools and insights to enhance your investment experience. Moreover, we offer
            tailored support and guidance to assist you in reaching your financial aspirations, making your journey with
            us both secure and enriching.
          </div>
        </div>
      </Wrapper>
    </section>
